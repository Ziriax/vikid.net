...
export const methods = methodDescriptions({
  ...
  [MethodId.RAY_CAST]: {
    _: overloadDescription("aangeraakte waarden", "met label", "zonder label", "actief?")
  },
  [MethodId.HIT_REGION]: {
  ...
  [MethodId.ITEM]: {
    _: overloadDescription("element(en)", "index of indices of condities", "wrap?", "https://nl.wikipedia.org/wiki/Array")
  },
  [MethodId.SEARCH]: {
